...
var TestPanel = require('./UI/TestPanel');
var DraggablePanel = require('./UI/DraggablePanel');
...
var tp = new TestPanel(context.addChild(), { x:120, y:100 });
var dp = new DraggablePanel(context.addChild(), tp);
